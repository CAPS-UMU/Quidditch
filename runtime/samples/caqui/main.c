...
int main() {
  ...
  model_config_t config = {
      .libraries =
          (iree_hal_executable_library_query_fn_t[]){
              quidditch_persimmon_linked_quidditch_library_query,
          },
      .num_libraries = 1,
      .module_constructor = persimmon_create,
  ...
  iree_string_view_t functions[] = {
      iree_make_cstring_view("persimmon.test32"),
      iree_make_cstring_view("persimmon.test40"),
  };
