builtin.module @pumpkin {
  ...
  // }
    func.func @matmulTiny(%lhs: tensor<64x64xf64>, %rhs: tensor<64x64xf64>, %acc: tensor<64x64xf64>) -> tensor<64x64xf64> {
  %result = linalg.matmul 
    ins(%lhs, %rhs: tensor<64x64xf64>, tensor<64x64xf64>)
    outs(%acc: tensor<64x64xf64>)
  -> tensor<64x64xf64>
  return %result: tensor<64x64xf64>
  }
