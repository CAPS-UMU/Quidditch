...
int run_fakeNN_experiment(
  ...
  double(*inputData)[mDim*kDim] = aligned_alloc(64, (mDim*kDim) * sizeof(double));
  double(*outputData)[mDim*nDim] = aligned_alloc(64, (mDim*nDim) * sizeof(double));
  ...
  model_config_t config = {
      ...
      .input_shapes = (const iree_hal_dim_t *[]){(iree_hal_dim_t[]){1, mDim, kDim}},
