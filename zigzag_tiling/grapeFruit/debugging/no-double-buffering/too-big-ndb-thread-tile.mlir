<eval_with_key>.0 from /home/hoppip/Quidditch/venv/lib/python3.11/site-packages/torch/fx/experimental/proxy_tensor.py:551 in wrapped:19:0: 
warning: Radish tiling level Thread This is the rewritten kernel!!!!!
...
func.func @main$async_dispatch_1_matmul_transpose_b_1x1200x400_f64() attributes {translation_info = #iree_codegen.translation_info<None>} {
  ...
  %24 = scf.for %arg0 = %c0 to %c400 step %c80 iter_args(%arg1 = %23) -> (tensor<1x1200xf64>) {
    ...
    %30 = scf.for %arg2 = %c0 to %c1200 step %c240 iter_args(%arg3 = %arg1) -> (tensor<1x1200xf64>) {
      %extracted_slice_8 = tensor.extract_slice %19[%arg2, %arg0] [240, 80] [1, 1] : tensor<1200x400xf64> to tensor<240x80xf64>
      %extracted_slice_9 = tensor.extract_slice %arg3[0, %arg2] [1, 240] [1, 1] : tensor<1x1200xf64> to tensor<1x240xf64>
      %result_10, %token_11 = dma.start_tensor_copy of %extracted_slice_8 to #quidditch_snitch.l1_encoding  -> tensor<240x80xf64>
      %31 = dma.wait_for_tensor_copy of %extracted_slice_8 : tensor<240x80xf64> to %result_10 using %token_11 -> tensor<240x80xf64>
      %result_12, %token_13 = dma.start_tensor_copy of %extracted_slice_9 to #quidditch_snitch.l1_encoding  -> tensor<1x240xf64>
      %32 = dma.wait_for_tensor_copy of %extracted_slice_9 : tensor<1x240xf64> to %result_12 using %token_13 -> tensor<1x240xf64>
      %33 = scf.forall (%arg4) = (0) to (240) step (30) shared_outs(%arg5 = %32) -> (tensor<1x240xf64>) {
        %extracted_slice_14 = tensor.extract_slice %29[0, 0] [1, 80] [1, 1] : tensor<1x80xf64> to tensor<1x80xf64>
        %extracted_slice_15 = tensor.extract_slice %31[%arg4, 0] [30, 80] [1, 1] : tensor<240x80xf64> to tensor<30x80xf64>
        %extracted_slice_16 = tensor.extract_slice %arg5[0, %arg4] [1, 30] [1, 1] : tensor<1x240xf64> to tensor<1x30xf64>
        %34 = linalg.matmul_transpose_b {lowering_config = #quidditch_snitch.lowering_config<l1_tiles = [0, 240, 80], l1_tiles_interchange = [0, 2, 1]>} ins(%extracted_slice_14, %extracted_slice_15 : tensor<1x80xf64>, tensor<30x80xf64>) outs(%extracted_slice_16 : tensor<1x30xf64>) -> tensor<1x30xf64>
        scf.forall.in_parallel {
          tensor.parallel_insert_slice %34 into %arg5[0, %arg4] [1, 30] [1, 1] : tensor<1x30xf64> into tensor<1x240xf64>
        }
      }
